...
from utils import assert_utils, DBUtils, read_add_emp, read_query_emp, read_modify_emp, read_delete_emp
import pymysql
...
class TestEmployee(unittest.TestCase):
    ...
    def test02_add_emp(self,username, mobile, http_code, success, code, message):
        ...
        assert_utils(self, response_add_emp, http_code, success, code, message)
    ...
    def test03_query_emp(self, http_code, success, code, message):
        ...
        # 断言结果：响应状态码，success，code，message
        assert_utils(self, response_query, http_code, success, code, message)
    ...
    def test04_modify_emp(self, username, http_code, success, code, message):
        ...
        # 断言结果：响应状态码，success，code，message
            assert_utils(self, response_modify, http_code, success, code, message)
    ...
    def test05_delete_emp(self, http_code, success, code, message):
        ...
        # 断言结果：响应状态码，success，code，message
        assert_utils(self, response_delete, http_code, success, code, message)
